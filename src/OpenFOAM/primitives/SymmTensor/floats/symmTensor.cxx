...
template<>
const char* const
Foam::SymmTensor<Foam::scalar>::vsType::typeName = "symmTensor";
...
(                                                                             \
    SymmTensor<Type>::uniform(Prefix##VGREAT)                                 \
);                                                                            \
                                                                              \
template<>                                                                    \
const Foam::SymmTensor<Type>                                                  \
...
(                                                                             \
    SymmTensor<Type>::uniform(Prefix##ROOTVGREAT)                             \
);                                                                            \
                                                                              \
template<>                                                                    \
const Foam::SymmTensor<Type>                                                  \
