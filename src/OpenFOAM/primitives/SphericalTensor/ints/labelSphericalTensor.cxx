...
template<>
const char* const Foam::SphericalTensor<Foam::label>::vsType::typeName
(
...
(                                                                             \
    SphericalTensor<Type>::uniform(Prefix##Max)                               \
);                                                                            \
                                                                              \
template<>                                                                    \
const Foam::SphericalTensor<Type>                                             \
...
(                                                                             \
    SphericalTensor<Type>::uniform(::sqrt(double(Prefix##Max)))               \
);                                                                            \
                                                                              \
template<>                                                                    \
const Foam::SphericalTensor<Type>                                             \
